...
export function VideoRow({
  ...
  return (
    <div className="group flex items-center gap-3 rounded-xl border border-border bg-white p-3 transition-colors hover:border-primary/30">
      {isReorderEnabled ? (
        <div
          className="flex-shrink-0 cursor-grab rounded-md p-1 transition-colors hover:bg-muted active:cursor-grabbing"
      ...
      <div className="h-10 w-16 flex-shrink-0 overflow-hidden rounded-lg bg-muted">
        {video.thumbnailUrl ? (
          <img
